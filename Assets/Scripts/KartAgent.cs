...
public class KartAgent : Agent
{
   ...
   #region Edit this region!
      ...
      public override void CollectObservations(VectorSensor sensor)
      {
         ...
         sensor.AddObservation(diff/20f); // Normalizing the distance to the next checkpoint         
      ...
      public override void OnActionReceived(ActionBuffers actions)
      {
         ...
         _kartController.Steer(input[0]); // Left/Right
         _kartController.ApplyAcceleration(input[1]); // Accelerate
      }
      ...
      public override void Heuristic(in ActionBuffers actionsOut)
      {
         ...
         action[0] = Input.GetAxis("Horizontal"); // Left/Right
         action[1] = Input.GetKey(KeyCode.W) ? 1f : 0f; // Accelerate
      }
